...
import com.rick.ricktour.repository.ExploreFragmentRepository
import com.rick.ricktour.utils.Event
    ...
    fun callApiTaipeiTour(language: Language?, currentPage: Int?, nlat: Double?, elong: Double?) {
        ...
        viewModelScope.launch {
            try {
                ...
                _isError.postValue(Event("讀取失敗，稍後再試 ${e.localizedMessage}"))
