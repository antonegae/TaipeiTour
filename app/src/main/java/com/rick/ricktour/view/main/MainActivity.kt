package com.rick.ricktour.view.main
...
import com.rick.ricktour.databinding.ActivityMainBinding
import com.rick.ricktour.databinding.TabItemBinding
import com.rick.ricktour.utils.Utils
import com.rick.ricktour.view.main.fragment.ExploreFragment
import com.rick.ricktour.view.main.fragment.HomeFragment
import com.rick.ricktour.view.main.fragment.NewsFragment
...
class MainActivity : AppCompatActivity(), FragNavController.TransactionListener, FragNavController.RootFragmentListener {
    ...
    override fun getRootFragment(index: Int): Fragment {
        ...
        //綁定tab與fragment
            ...
            else -> throw IllegalStateException("rick send an index that we know?")
        ...
        mNavController.apply {
            ...
            fragNavLogger = object : FragNavLogger {
                override fun error(message: String, throwable: Throwable) {
                    Log.e("MainActivity initFragment()", message, throwable)
                }
            }
